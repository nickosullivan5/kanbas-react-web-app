...
export default function KambazNavigation() {
    return (
        <div id="wd-kambaz-navigation" style={{width: 85, fontSize: "small"} }
             className="list-group rounded-0 position-fixed bottom-0 top-0 d-none d-md-block bg-black z-2 pt-4">
            ...
            <Link to="/Kambaz/Account" id="wd-account-link"
                ...
                <FaRegCircleUser size={25} className="fs-1 text text-white"/><br/>
                Account
            </Link>
            ...
            <Link to="/Kambaz/Dashboard" id="wd-dashboard-link"
                ...
                <AiOutlineDashboard size={25} className="fs-1 text-danger"/><br/>
                Dashboard
            </Link>
            ...
            <Link to="/Kambaz/Dashboard" id="wd-course-link"
                ...
                <LiaBookSolid size={25} className="fs-1 text-danger"/><br/>
                Courses
            </Link>
            ...
            <Link to="/Kambaz/Calendar" id="wd-calendar-link"
                  className="list-group-item text-white
                  bg-black text-center border-0">
                <IoCalendarOutline size={25} className="fs-1 text-danger"/><br/>Calendar
            </Link>

            <Link to="/Kambaz/Inbox" id="wd-inbox-link"
                  className="list-group-item text-white bg-black text-center border-0">
                <FaInbox size={25} className="fs-1 text-danger"/><br/>Inbox
            </Link>
