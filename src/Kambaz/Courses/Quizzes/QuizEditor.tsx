                ...
                <Tab eventKey="details" title="Details">
                    <Form>
                        ...
                        <div className="d-flex gap-2">
                            ...
                            <Link to={`/Kambaz/Courses/${cid}/Quizzes`}>
                                <Button variant="danger" onChange={() => setPublished(true)}>Save & Publish</Button>
                            </Link>
                ...
                <Tab eventKey="questions" title="Questions">
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            ...
                            <span
                                className="text-muted-foreground">Total Points: {points}</span>
                        </div>
                                ...
                                {q.type === "Fill In The Blank" && (
                                    <div>
                                        ...
                                        <ul className="list-disc pl-6">
                                            {q.possibleAnswers.map((ans: any, i: any) => (
                                                <li key={i}>{ans}</li>
                                            ))}
                                        </ul>
                                    </div>
                        ...
                        <div>
                            <Link to={`/Kambaz/Courses/${cid}/Quizzes`}>
                                <Button variant="danger" onClick={() => {updateQuizForCourse()}}>Save</Button>
                            </Link>
