    ...
    <tbody>
     ...
     <tr>
         <td className="wd-full-name text-nowrap">
          ...
          <span className="wd-last-name">Osullivan</span></td>
          <td className="wd-login-id">002123124</td>
          <td className="wd-section">S101</td>
          <td className="wd-role">STUDENT</td>
          <td className="wd-last-activity">2020-11-01</td>
          <td className="wd-total-activity">22:21:32</td>
     </tr>
     <tr>
         <td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          ...
          <td className="wd-login-id">00212233224</td>
     ...
     <tr>
         <td className="wd-full-name text-nowrap">
          ...
          <td className="wd-login-id">0021225524</td>
          <td className="wd-section">S102</td>
          <td className="wd-role">STUDENT</td>
          <td className="wd-last-activity">2020-10-05</td>
          <td className="wd-total-activity">20:00:32</td>
     </tr>
    </tbody>
   </Table>
  </div> );}