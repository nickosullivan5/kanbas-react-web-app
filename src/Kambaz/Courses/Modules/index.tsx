                ...
                <ListGroup className="rounded-0" id="wd-modules">
                    <ListGroup.Item className="wd-module p-0 mb-5 fs-5 border-gray">
                        ...
                        <ListGroup className="wd-lessons rounded-0">
                            ...
                            <ListGroup.Item className="wd-lesson p-3 ps-1 fs-6">
                                <BsGripVertical className="me-2 fs-5"/> Introduction to the
                                course <LessonControlButtons/>

                            </ListGroup.Item>
                            <ListGroup.Item className="wd-lesson p-3 ps-1 fs-6">
                                <BsGripVertical className="me-2 fs-5"/> Learn what is web
                    ...
                    <ListGroup.Item className="wd-module p-0 mb-5 fs-5 border-gray">
                            <div className="wd-title p-3 ps-2 bg-secondary"><BsGripVertical className="me-2 fs-3"/>Week
                            3 <ModuleControlButtons/></div>
                        <ListGroup className="wd-lessons rounded-0">
                            <ListGroup.Item className="wd-lesson p-3 ps-1 fs-6">
                                <BsGripVertical className="me-2 fs-5"/> CSS selectors and
                                properties<LessonControlButtons/>
                            </ListGroup.Item>
                            <ListGroup.Item className="wd-lesson p-3 ps-1 fs-6">
                                <BsGripVertical className="me-2 fs-5"/> Box model and layout
                                techniques<LessonControlButtons/>
                            </ListGroup.Item>
                        </ListGroup>
                    </ListGroup.Item>
                    <ListGroup.Item className="wd-module p-0 mb-5 fs-5 border-gray">
